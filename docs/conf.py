#!/usr/bin/env python3
#
# zema_emc_annotated_dataset documentation build
...
project = "zema_emc_annotated_dataset"
...
htmlhelp_basename = "zema_emc_annotated_dataset"
...
latex_documents = [
    (
        root_doc,
        "zema_emc_annotated_dataset.tex",
        "zema_emc_annotated_dataset Documentation",
        "B. Ludwig",
        "manual",
    ),
]
